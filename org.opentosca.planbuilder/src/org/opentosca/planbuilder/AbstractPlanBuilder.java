...
public abstract class AbstractPlanBuilder {
	 ...
	 *
	 * @param csarName
	 *            the file name of the CSAR as String
	 * @param definitions
	 *            the Definitions document as AbstractDefinitions Object
	 * @param serviceTemplateId
	 *            a QName denoting a ServiceTemplate inside the Definitions document
	 ...
	 *
	 * @param csarName
	 *            the file name of CSAR
	 * @param definitions
	 *            a AbstractDefinitions Object denoting the Definitions document
	...
	public IPlanBuilderTestPlugin findTestPlugin(AbstractPolicy policy,
			AbstractNodeTemplate nodeTemplate) {
		for (final IPlanBuilderTestPlugin plugin : this.pluginRegistry.getTestPlugins()) {
			if (plugin.canHandle(nodeTemplate, policy)) {
				return plugin;
			}
		}
		LOG.error("No TestPlugin was found for test policy {} on NodeTemplate {}", policy.getName(),
	 ...
	 *
	 * @param nodeTemplate
	 *            an AbstractNodeTemplate denoting a NodeTemplate
	 ...
	 *
	 * @param context
	 *            a TemplatePlanContext which was initialized for the given
	 *            RelationshipTemplate
	 * @param nodeTemplate
	 *            a RelationshipTemplate as an AbstractRelationshipTemplate
	 ...
	 *            the relationshipTemplate the activity belongs to
	 * @param type
