...
public class BPELPlanContext implements PlanContext {
	 ...
	 *            the name of the ServiceTemplate where the Template of the context
	 *            originates
	 * @param map
	 *            a PropertyMap containing mappings for all Template properties of
	 *            the TopologyTemplate the ServiceTemplate has
	 */
	...
	/**
	 * Adds a copy element to the main assign element of the buildPlan this context
	 * belongs to
	 *
	 ...
	 * @param partnerRole
	 *            the name of a role inside ther partnerLinkType for the partnerRole
	...
	/**
	 * Adds a partnerlinkType to the BuildPlan, which can be used for partnerLinks
	 * in the TemplateBuildPlan
	 *
	...
	/**
	 * Adds a variable to the TemplateBuildPlan of the template this context belongs
	 * to
	 *
	 * @param name
	 ...
	 *            If a Map of Parameter to Variable is given this will be used for
	 *            the operation call
	...
	public boolean executeOperation(final AbstractNodeTemplate nodeTemplate, final String interfaceName,
		...
		/*
		 * create a new templatePlanContext that combines the requested nodeTemplate and
	...
	/**
	 * Returns an Integer which can be used as variable names etc. So that there are
	 * no collisions with other declarations
	 *
	 * @return an Integer
	 */
	 ...
	 *
	 * @return a List of AbstractRelationshipTemplate which are InfrastructureEdges
	 *         of the template this context handles
	 */
	 ...
	 *
	 * @return a List of AbstractNodeTemplate which are InfrastructureNodeTemplate
	 *         of the template this context handles
	 */
	 ...
	 *
	 * @param forSource
	 *            whether to look for InfrastructureNodes along the Source relations
	 *            or Target relations
	 * @return a List of AbstractNodeTemplate which are InfrastructureNodeTemplate
	 *         of the template this context handles
	 */
	...
	/**
	 * Returns the localNames defined inside the input message of the buildPlan this
	 * context belongs to
	 *
	 ...
	 *            Set of Parameter Names for which the list of internal properties
	 *            or external properties should be calculated
	...
	public boolean executeOperation(final AbstractNodeTemplate nodeTemplate, final String interfaceName,
			final String operationName, final Map<AbstractParameter, Variable> param2propertyMapping,
			final Map<AbstractParameter, Variable> param2propertyOutputMapping, final BPELScopePhaseType phase) {
		final OperationChain chain = BPELScopeBuilder.createOperationCall(nodeTemplate, interfaceName, operationName);
		if (chain == null) {
			return false;
		}
	 ...
	 *
	 * @return an AbstractNodeTemplate if this BPELPlanContext handles a
	...
	/**
	 * <p>
	 * Returns all NodeTemplates that are part of the ServiceTemplate this context
	 * belongs to.
	 * </p>
	 *
	...
	/**
	 * Returns the WSDL Ports of the given WSDL Service, that have binding with the
	 * given WSDL PortType
	 *
	 * @param service
	 *            the WSDL Service
	 ...
	 * @return a List of Port which belong to the service and have a Binding with
	 *         the given PortType
	 */
	...
	/**
	 * Returns a List of Port which implement the given portType inside the given
	 * WSDL File
	 *
	 * @param portType
	 *            the portType to use
	 ...
	 * @throws WSDLException
	 *             is thrown when the given File is not a WSDL File or initializing
	...
	/**
	 * Returns the PostPhase Element of the TemplateBuildPlan this context belongs
	 * to
	 *
	...
	/**
	 *
	 * Looks for a Property with the same localName as the given String. The search
	 * is on either the Infrastructure on the Source or Target of the Template this
	 * TemplateContext belongs to.
	 *
	 * @param localName
	 *            a String
	 * @param forSource
	 *            whether to look in direction of the sinks or sources (If Template
	 *            is NodeTemplate) or to search on the Source-/Target-Interface (if
	 *            template is RelationshipTemplate)
	 * @return a Variable Object with TemplateId and Name, if null the whole
	...
	/**
	 * Returns the ProvPhase Element of the TemplateBuildPlan this context belongs
	 * to
	 *
	...
	/**
	 * <p>
	 * Returns all RelationshipTemplates that are part of the ServiceTemplate this
	 * context belongs to.
	 * </p>
	 *
	 ...
	 *
	 * @return a String containing a Name for the TemplateBuildPlan consisting of
	 *         the Id of the NodeTemplate processed in that plan
	 */
	...
	/**
	 * Returns the variable name of the first occurence of a property with the given
	 * Property name of InfrastructureNodes
	 *
	 * @param propertyName
	 ...
	 *
	 * @param propertyName
	 *            a LocalName of a Property of the Template this context belongs to
	...
	/**
	 * Imports the given Node into the BuildPlan Document, to be able to append it
	 * to the Phases
	 *
	 * @param node
	 ...
	 * @return a QName for portType with set prefix etc. after registration within
	 *         the BuildPlan
	 */
	...
	public void setNodeTemplate(AbstractNodeTemplate nodeTemplate) {
		this.templateBuildPlan.setNodeTemplate(nodeTemplate);
	}
}
