...
public class DefinitionsImpl extends AbstractDefinitions {
	...
	private void initTypesAndTemplates() {
		for (final TExtensibleElements element : this.definitions
			...
			if (element instanceof TRelationshipTypeImplementation) {
				addRelationshipTypeImplementation(
	 ...
	 *            an AbstractPolicyTemplate to add to this DefinitionsImpl
	 */
	...
	/**
	 * <<<<<<< HEAD ======= Returns a List of all policyTemplates in the current
	 * csar context of this definitions document
	 *
	...
	/**
	 * >>>>>>> master Returns a List of all nodeTypes in the current csar context of
