...
@XmlType(name = "tDefinitions",
         propOrder = {"extensions", "_import", "types", "serviceTemplateOrNodeTypeOrNodeTypeImplementation"})
...
public class TDefinitions extends TExtensibleElements {
    ...
    @XmlElements({@XmlElement(name = "PolicyType", type = TPolicyType.class),
     ...
     *
     */
    public void setExtensions(final TDefinitions.Extensions value) {
     ...
     * there is not a <CODE>set</CODE> method for the import property.
     *
     * <p>
     ...
     *
     */
    public void setTypes(final TDefinitions.Types value) {
        this.types = value;
    }
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is why
     * there is not a <CODE>set</CODE> method for the serviceTemplateOrNodeTypeOrNodeTypeImplementation
     * property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TPolicyType }
     * {@link TRelationshipType } {@link TNodeType } {@link TCapabilityType } {@link TRequirementType }
     * {@link TNodeTypeImplementation } {@link TArtifactType } {@link TPolicyTemplate }
     * {@link TArtifactTemplate } {@link TRelationshipTypeImplementation } {@link TServiceTemplate }
     *
     *
     */
    public List<TExtensibleElements> getServiceTemplateOrNodeTypeOrNodeTypeImplementation() {
        if (this.serviceTemplateOrNodeTypeOrNodeTypeImplementation == null) {
            this.serviceTemplateOrNodeTypeOrNodeTypeImplementation = new ArrayList<>();
        }
