...
public class ServiceTemplateImpl extends AbstractServiceTemplate {
	...
	public List<AbstractGroup> getGroups() {
		List<AbstractGroup> groups = new ArrayList<AbstractGroup>();

		if (this.serviceTemplate.getGroups() != null) {
			for (TGroup group : this.serviceTemplate.getGroups().getGroup()) {
				groups.add(new GroupImpl(definitions, this, group));
			}
		}
